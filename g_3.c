...
void main (){
    ...
    char perg5 [NUM_STRING][MAX_STRING_SIZE] = {""};
    char perg6 [NUM_STRING][MAX_STRING_SIZE] = {};
    char perg7 [NUM_STRING][MAX_STRING_SIZE] = {};
    char perg8 [NUM_STRING][MAX_STRING_SIZE] = {};
    char perg9 [NUM_STRING][MAX_STRING_SIZE] = {};
    char perg10 [NUM_STRING][MAX_STRING_SIZE] = {};
